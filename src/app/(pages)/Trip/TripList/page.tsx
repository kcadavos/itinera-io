...
const TripList = () => {
  ...
  useEffect(() => {
    ...
    if (userId) {
      // if user refreshes the page, get the userId from session storage
      getTripListData();
      ...
      {tripListData.length === 0 && (
        <div className="flex flex-col items-center justify-center text-center mt-24 px-4">
          ...
          <p className="text-gray-600 mt-2 max-w-md">
            Welcome to your Trips Dashboard! You haven&apos;t planned a trip yet
            — but adventure is just a few clicks away. Start building your first
            getaway!
          </p>
        </div>
      )}
