  ...
  useEffect (()=>{
   ...
   {/* value is for indicating what is collapsed in the accordion*/ }
    ...
    <p className="font-normal text-lg text-white">{format(new Date(trip.startDate+"T12:00:00"),'MMM dd')}-{format(new Date(trip.endDate+"T12:00:00"),'MMM dd')}</p>
     ...
     <p className=" text-center font-normal text-3xl lg:text-2xl text-white mb-5 " >{trip.isVotingOpen? "Voting in Progress" : "Itinerary generated"}</p>

    <div className='flex justify-between '>
      <div className='flex  flex-col  items-center gap-2 cursor-pointer hover:opacity-80' onClick={()=>handleEditTrip()}>
        <img src="/assets/Icons/Orion_aircraft_lightweight_white.svg" alt="Edit/ View Trip Details" className='w-auto h-20 lg:h-12'/>
