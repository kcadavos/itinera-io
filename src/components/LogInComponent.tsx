...
const LogInComponent = () => {
  ...
  return (
    <div className=''>
      ...
      <div className="flex justify-start my-4 lg:my-8 pt-20 lg:pt-8">
      ...
      <div className="flex justify-center my-4 absolute -bottom-9 left-1/2 transform -translate-x-1/2 ">
        <button id="login-btn" className="bg-[#E67E22] hover:bg-[#d56b0f] lg:border-4 lg:border-white text-xl text-white rounded-xl p-[.6rem] px-12 lg:px-14 cursor-pointer" onClick={submitLogin}>Log In</button>
      </div>
