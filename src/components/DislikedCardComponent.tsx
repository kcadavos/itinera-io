            ...
            <div className='flex justify-between mb-3'>
...

             {
                ...
                <div className="hidden lg:flex justify-center mt-18 absolute -bottom-7 left-75 xl:left-[28rem] transform -translate-x-1/2">
                    <button className="bg-[#1ABC9C] hover:bg-[#67afa0] border-2 border-white text-xl text-white rounded-[2.5rem] p-[.1rem] cursor-pointer lg:px-5 lg:flex lg:justify-between" onClick={() => removeVoteFromDisliked(activity.id, "no")} >
